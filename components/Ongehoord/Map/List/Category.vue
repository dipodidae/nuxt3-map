...
<template>
  <div v-show="category.visible" class="ongehoord-map-list-category">
    <a href="#" class="flex hover:bg-stone-700 p-5 border-b border-stone-400 text-stone-300 text-lg capitalize font-semibold" @click="toggleFilterByCategory(props.category)">
